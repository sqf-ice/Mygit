...
typedef enum {
	...
	NDK_ERR_APP_ADDRESS_NOT_LEGAL=(NDK_ERR_APP_BASE-26), /*地址非法*/
	NDK_ERR_APP_PUBKEY_NOT_MATCH=(NDK_ERR_APP_BASE-27),	/*公钥不匹配*/
	NDK_ERR_APP_OTP_MAC_SAVE_FAIL=(NDK_ERR_APP_BASE-28),	/*otp保存mac失败*/
	NDK_ERR_APP_OTP_OP_CUSTOM_FLAG_FAIL=(NDK_ERR_APP_BASE-29),	/*otp操作定制公钥标志失败*/
...
/**
 *@brief	校验NLP包
 *@param	buf	校验失败的name,buf大小为50x19字节
 *@param	nr	校验失败的NLP数目
 *@return
 *@li	NDK_OK				操作成功
 *@li	\ref NDK_ERR_PARA "NDK_ERR_PARA" 		参数非法(pszAppName为NULL)
 *@li	\ref NDK_ERR_APP_SIGN_CHECK 	签名数据校验错误
*/
int NDK_NlpVerify(char *buf, int *nr);
...
*@li\ref NDK_ERR_GPRS_UNINIT " NDK_ERR_GPRS_UNINIT " 	GPRS未初始化
*@li\ref NDK_ERR_GPRS_BUSY " NDK_ERR_GPRS_BUSY "  系统有命令未处理
*@li\ref NDK_ERR_GPRS_UNKNOWN_AT_CMD " NDK_ERR_GPRS_UNKNOWN_AT_CMD "  不识别的AT指令
*/
