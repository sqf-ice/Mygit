...
*/
/**
 *@brief	蓝牙模块复位   (ME30需求接口，这里直接返回NDK_OK)
 *@return
 *@li	NDK_OK				操作成功
 *@li	\ref NDK_ERR "NDK_ERR"	操作失败
*/
...
/** @} */ // 音频模块结束
 ...
 int NDK_ScrDrawBitmapV(uint unX,uint unY,uint unWidth,
         uint unHeight, const uchar *psBuf);
