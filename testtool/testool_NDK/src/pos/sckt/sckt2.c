...
* DATE				: 20130105
* directory 	: 
* description	: 测试NDK_TcpClose和NDK_TcpWait接口功能
...
void sckt2(void)
{
	...
	//case1:打开一个sock句柄，连接，关闭一个sock句柄
	...
	//case2:关闭句柄后再连接应该失败，低端返回NDK_ERR_LINUX_TCP_NOT_OPEN
#if K21_ENABLE
	...
	//case3:异常测试
	//case3.1关闭已关闭句柄，应失败返回，低端返回NDK_ERR_LINUX_TCP_NOT_OPEN
#if K21_ENABLE
	...
	//case3.2关闭一个空的句柄，应失败返回，低端返回NDK_ERR_LINUX_TCP_NOT_OPEN
#if K21_ENABLE
