...
* DATE			:
* directory 		: 
* description		: 测试 NDK_SecVerifyPlainPin 接口功能
...
#define TESTAPI	"NDK_SecVerifyPlainPin"	
...
void sec12(void)
{
	...
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"0", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MIN)) != NDK_ERR_SECVP_NOT_ACTIVE)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"4,5,6,7,8,9,10,11,12", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MIN-1)) != NDK_ERR_PARA)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	memset(sSW, 0, sizeof(sSW));
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"4,5,6,7,8,9,10,11,12", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX+1)) != NDK_ERR_PARA)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	memset(sSW, 0, sizeof(sSW));
	if((ret = NDK_SecVerifyPlainPin(0, NULL, sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_ERR_PARA)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	memset(sSW, 0, sizeof(sSW));
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"0", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MIN)) != NDK_ERR_SECVP_CUSTOMERCARDNOTPRESENT)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	memset(sSW, 0, sizeof(sSW));
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"4,5,12", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MIN)) != NDK_ERR_SECVP_CUSTOMERCARDNOTPRESENT)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"0", sSW, ICC_EMV_MODE-1, PINTIMEOUT_MAX)) != NDK_ERR_PARA)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	memset(sSW, 0, sizeof(sSW));
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"4", sSW, ICC_EMV_MODE+1, PINTIMEOUT_MAX)) != NDK_ERR_PARA)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
...
#endif
#endif
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"0", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_OK)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	cls_printf("请尽快按[确认]...");
#endif
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"0,0,0", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_OK)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
...
#endif
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"4,4", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_OK)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
...
#endif
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"6", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_OK)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
...
#endif
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"12", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_OK)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	memset(sSW, 0, sizeof(sSW));
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"3", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_ERR_PARA)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	memset(sSW, 0, sizeof(sSW));
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"13", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_ERR_PARA)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
...
#endif
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"12", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_ERR_SECVP_GET_ESC)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
...
#endif
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"4,5,12", NULL, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_OK)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
	...
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"4", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MIN)) != NDK_ERR_SECVP_TIMED_OUT)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
...
#endif
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"4", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_OK)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
...
#endif
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"6,4", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_OK)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
...
#endif
	if((ret = NDK_SecVerifyPlainPin(0, (uchar*)"8,6,4", sSW, 1/*ICC_EMV_MODE*/, PINTIMEOUT_MAX)) != NDK_OK)
	{
		send_result("line %d:%s测试失败(%d)", __LINE__, TESTAPI, ret);
		GOTOERR;
	}
