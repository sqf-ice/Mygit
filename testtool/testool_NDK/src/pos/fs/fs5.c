...
#if CPU5810X_ENABLE//!defined SP610	//郑凯解释SP610底层会增加上"appfs/"而低端平台"appfs//"是合法文件名,故SP610不测试该用例
	//5810平台产品都是返回-4(除了喔噻ME50N) 张兆鑫解释 20180427 modify
